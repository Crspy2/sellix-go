...
// checks if the GetBlacklist200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBlacklist200Response{}

// GetBlacklist200Response struct for GetBlacklist200Response
type GetBlacklist200Response struct {
	Status *int32 `json:"status,omitempty"`
	Data *GetBlacklist200ResponseData `json:"data,omitempty"`
...
func (o *GetBlacklist200Response) GetData() GetBlacklist200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret GetBlacklist200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given GetBlacklist200ResponseData and assigns it to the Data field.
...
func (o GetBlacklist200Response) MarshalJSON() ([]byte, error) {
...
func (o GetBlacklist200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetBlacklist200Response struct {
	value *GetBlacklist200Response
	isSet bool
}

func (v NullableGetBlacklist200Response) Get() *GetBlacklist200Response {
	return v.value
}

func (v *NullableGetBlacklist200Response) Set(val *GetBlacklist200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlacklist200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlacklist200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlacklist200Response(val *GetBlacklist200Response) *NullableGetBlacklist200Response {
	return &NullableGetBlacklist200Response{value: val, isSet: true}
}

func (v NullableGetBlacklist200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlacklist200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
