...
// checks if the ListCoupons200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListCoupons200Response{}

// ListCoupons200Response struct for ListCoupons200Response
type ListCoupons200Response struct {
	Status *int32 `json:"status,omitempty"`
	Data *ListCoupons200ResponseData `json:"data,omitempty"`
...
func (o *ListCoupons200Response) GetData() ListCoupons200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret ListCoupons200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ListCoupons200ResponseData and assigns it to the Data field.
...
func (o ListCoupons200Response) MarshalJSON() ([]byte, error) {
...
func (o ListCoupons200Response) ToMap() (map[string]interface{}, error) {
...
type NullableListCoupons200Response struct {
	value *ListCoupons200Response
	isSet bool
}

func (v NullableListCoupons200Response) Get() *ListCoupons200Response {
	return v.value
}

func (v *NullableListCoupons200Response) Set(val *ListCoupons200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListCoupons200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListCoupons200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCoupons200Response(val *ListCoupons200Response) *NullableListCoupons200Response {
	return &NullableListCoupons200Response{value: val, isSet: true}
}

func (v NullableListCoupons200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCoupons200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
