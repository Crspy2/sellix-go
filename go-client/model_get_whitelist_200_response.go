...
// checks if the GetWhitelist200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetWhitelist200Response{}

// GetWhitelist200Response struct for GetWhitelist200Response
type GetWhitelist200Response struct {
	Status *int32 `json:"status,omitempty"`
	Data *GetWhitelist200ResponseData `json:"data,omitempty"`
...
func (o *GetWhitelist200Response) GetData() GetWhitelist200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret GetWhitelist200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given GetWhitelist200ResponseData and assigns it to the Data field.
...
func (o GetWhitelist200Response) MarshalJSON() ([]byte, error) {
...
func (o GetWhitelist200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetWhitelist200Response struct {
	value *GetWhitelist200Response
	isSet bool
}

func (v NullableGetWhitelist200Response) Get() *GetWhitelist200Response {
	return v.value
}

func (v *NullableGetWhitelist200Response) Set(val *GetWhitelist200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWhitelist200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWhitelist200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWhitelist200Response(val *GetWhitelist200Response) *NullableGetWhitelist200Response {
	return &NullableGetWhitelist200Response{value: val, isSet: true}
}

func (v NullableGetWhitelist200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWhitelist200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
