...
// checks if the GetFeedback200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFeedback200Response{}

// GetFeedback200Response struct for GetFeedback200Response
type GetFeedback200Response struct {
	Status *int32 `json:"status,omitempty"`
	Data *GetFeedback200ResponseData `json:"data,omitempty"`
...
func (o *GetFeedback200Response) GetData() GetFeedback200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret GetFeedback200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given GetFeedback200ResponseData and assigns it to the Data field.
...
func (o GetFeedback200Response) MarshalJSON() ([]byte, error) {
...
func (o GetFeedback200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetFeedback200Response struct {
	value *GetFeedback200Response
	isSet bool
}

func (v NullableGetFeedback200Response) Get() *GetFeedback200Response {
	return v.value
}

func (v *NullableGetFeedback200Response) Set(val *GetFeedback200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFeedback200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFeedback200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFeedback200Response(val *GetFeedback200Response) *NullableGetFeedback200Response {
	return &NullableGetFeedback200Response{value: val, isSet: true}
}

func (v NullableGetFeedback200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFeedback200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
