...
type CreateProductRequest struct {
	...
	// key-value pairs for custom metadata to be included in the invoice throughout its lifetime
	...
	ProductPlans []ProductPlanRequest `json:"product_plans,omitempty"`
}
...
// SetProductPlans gets a reference to the given []ProductPlanRequest and assigns it to the ProductPlans field.
