...
// checks if the CreateWhitelist200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateWhitelist200Response{}

// CreateWhitelist200Response struct for CreateWhitelist200Response
type CreateWhitelist200Response struct {
...
func NewCreateWhitelist200Response() *CreateWhitelist200Response {
	this := CreateWhitelist200Response{}
	return &this
}
...
func (o CreateWhitelist200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateWhitelist200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateWhitelist200Response struct {
	value *CreateWhitelist200Response
	isSet bool
}

func (v NullableCreateWhitelist200Response) Get() *CreateWhitelist200Response {
	return v.value
}

func (v *NullableCreateWhitelist200Response) Set(val *CreateWhitelist200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateWhitelist200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateWhitelist200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateWhitelist200Response(val *CreateWhitelist200Response) *NullableCreateWhitelist200Response {
	return &NullableCreateWhitelist200Response{value: val, isSet: true}
}

func (v NullableCreateWhitelist200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateWhitelist200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
