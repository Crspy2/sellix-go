...
// checks if the CompletePayment200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompletePayment200Response{}

// CompletePayment200Response struct for CompletePayment200Response
type CompletePayment200Response struct {
	Status *int32 `json:"status,omitempty"`
	Data map[string]interface{} `json:"data,omitempty"`
	Error *string `json:"error,omitempty"`
	Message *string `json:"message,omitempty"`
	Env *string `json:"env,omitempty"`
	Log *CompletePayment200ResponseLog `json:"log,omitempty"`
}
...
func NewCompletePayment200Response() *CompletePayment200Response {
	this := CompletePayment200Response{}
	return &this
}
...
func (o *CompletePayment200Response) GetLog() CompletePayment200ResponseLog {
	if o == nil || IsNil(o.Log) {
		var ret CompletePayment200ResponseLog
		return ret
	}
	return *o.Log
}
...
// SetLog gets a reference to the given CompletePayment200ResponseLog and assigns it to the Log field.
func (o *CompletePayment200Response) SetLog(v CompletePayment200ResponseLog) {
	o.Log = &v
}

func (o CompletePayment200Response) MarshalJSON() ([]byte, error) {
...
func (o CompletePayment200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCompletePayment200Response struct {
	value *CompletePayment200Response
	isSet bool
}

func (v NullableCompletePayment200Response) Get() *CompletePayment200Response {
	return v.value
}

func (v *NullableCompletePayment200Response) Set(val *CompletePayment200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCompletePayment200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCompletePayment200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompletePayment200Response(val *CompletePayment200Response) *NullableCompletePayment200Response {
	return &NullableCompletePayment200Response{value: val, isSet: true}
}

func (v NullableCompletePayment200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompletePayment200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
