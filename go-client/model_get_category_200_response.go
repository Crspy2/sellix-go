...
// checks if the GetCategory200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCategory200Response{}

// GetCategory200Response struct for GetCategory200Response
type GetCategory200Response struct {
	Status *int32 `json:"status,omitempty"`
	Data *GetCategory200ResponseData `json:"data,omitempty"`
...
func (o *GetCategory200Response) GetData() GetCategory200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret GetCategory200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given GetCategory200ResponseData and assigns it to the Data field.
...
func (o GetCategory200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCategory200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetCategory200Response struct {
	value *GetCategory200Response
	isSet bool
}

func (v NullableGetCategory200Response) Get() *GetCategory200Response {
	return v.value
}

func (v *NullableGetCategory200Response) Set(val *GetCategory200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCategory200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCategory200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCategory200Response(val *GetCategory200Response) *NullableGetCategory200Response {
	return &NullableGetCategory200Response{value: val, isSet: true}
}

func (v NullableGetCategory200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCategory200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
