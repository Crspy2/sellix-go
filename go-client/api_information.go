...
func (r ApiGetSelfRequest) XSellixMerchant(xSellixMerchant string) ApiGetSelfRequest {
	r.xSellixMerchant = &xSellixMerchant
	return r
}

func (r ApiGetSelfRequest) Execute() (*GetSelf200Response, *http.Response, error) {
...
*/
func (a *InformationAPIService) GetSelf(ctx context.Context) ApiGetSelfRequest {
	return ApiGetSelfRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return GetSelf200Response
func (a *InformationAPIService) GetSelfExecute(r ApiGetSelfRequest) (*GetSelf200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSelf200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InformationAPIService.GetSelf")
	if err != nil {
