...
// checks if the ListSubscriptionv2200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListSubscriptionv2200Response{}

// ListSubscriptionv2200Response struct for ListSubscriptionv2200Response
type ListSubscriptionv2200Response struct {
	Status *int32 `json:"status,omitempty"`
	Data *ListSubscriptionv2200ResponseData `json:"data,omitempty"`
...
func NewListSubscriptionv2200Response() *ListSubscriptionv2200Response {
	this := ListSubscriptionv2200Response{}
	return &this
}
...
func (o *ListSubscriptionv2200Response) GetData() ListSubscriptionv2200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret ListSubscriptionv2200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ListSubscriptionv2200ResponseData and assigns it to the Data field.
...
func (o ListSubscriptionv2200Response) MarshalJSON() ([]byte, error) {
...
func (o ListSubscriptionv2200Response) ToMap() (map[string]interface{}, error) {
...
type NullableListSubscriptionv2200Response struct {
	value *ListSubscriptionv2200Response
	isSet bool
}

func (v NullableListSubscriptionv2200Response) Get() *ListSubscriptionv2200Response {
	return v.value
}

func (v *NullableListSubscriptionv2200Response) Set(val *ListSubscriptionv2200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListSubscriptionv2200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListSubscriptionv2200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSubscriptionv2200Response(val *ListSubscriptionv2200Response) *NullableListSubscriptionv2200Response {
	return &NullableListSubscriptionv2200Response{value: val, isSet: true}
}

func (v NullableListSubscriptionv2200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSubscriptionv2200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
