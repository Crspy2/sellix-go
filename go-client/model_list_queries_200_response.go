...
// checks if the ListQueries200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListQueries200Response{}

// ListQueries200Response struct for ListQueries200Response
type ListQueries200Response struct {
	Status *int32 `json:"status,omitempty"`
	Data *ListQueries200ResponseData `json:"data,omitempty"`
...
func (o *ListQueries200Response) GetData() ListQueries200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret ListQueries200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ListQueries200ResponseData and assigns it to the Data field.
...
func (o ListQueries200Response) MarshalJSON() ([]byte, error) {
...
func (o ListQueries200Response) ToMap() (map[string]interface{}, error) {
...
type NullableListQueries200Response struct {
	value *ListQueries200Response
	isSet bool
}

func (v NullableListQueries200Response) Get() *ListQueries200Response {
	return v.value
}

func (v *NullableListQueries200Response) Set(val *ListQueries200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListQueries200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListQueries200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListQueries200Response(val *ListQueries200Response) *NullableListQueries200Response {
	return &NullableListQueries200Response{value: val, isSet: true}
}

func (v NullableListQueries200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListQueries200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
