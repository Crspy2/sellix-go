...
// checks if the FeedbackProduct type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeedbackProduct{}

// FeedbackProduct struct for FeedbackProduct
type FeedbackProduct struct {
	...
	// The file to deliver to the customer (if applicable)
	...
	// Stringified array of volume discounts.
	VolumeDiscounts *string `json:"volume_discounts,omitempty"`
	...
	// The max fraud score to allow a customer to have when purchasing the product
	...
	// If type is SERVICE, then this will be delivered as the product when an invoice is processed
	...
	TelegramIntegration *float32 `json:"telegram_integration,omitempty"`
	TelegramOptional *float32 `json:"telegram_optional,omitempty"`
	// The name of the store the invoice was created on
	Name *string `json:"name,omitempty"`
	// DEPRECATED: The name of the image for the store the invoice was created on
	...
	Feedback *FeedbackProductFeedback `json:"feedback,omitempty"`
	Categories []FeedbackProductCategoriesInner `json:"categories,omitempty"`
	PaymentGatewaysFees []FeedbackProductPaymentGatewaysFeesInner `json:"payment_gateways_fees,omitempty"`
...
// SetFileAttachment gets a reference to the given map[string]interface{} and assigns it to the FileAttachment field.
...
// SetVolumeDiscounts gets a reference to the given string and assigns it to the VolumeDiscounts field.
...
// SetTelegramIntegration gets a reference to the given float32 and assigns it to the TelegramIntegration field.
...
// SetTelegramOptional gets a reference to the given float32 and assigns it to the TelegramOptional field.
...
func (o *FeedbackProduct) GetFeedback() FeedbackProductFeedback {
	if o == nil || IsNil(o.Feedback) {
		var ret FeedbackProductFeedback
		return ret
	}
	return *o.Feedback
}
...
// SetFeedback gets a reference to the given FeedbackProductFeedback and assigns it to the Feedback field.
...
func (o *FeedbackProduct) GetPaymentGatewaysFees() []FeedbackProductPaymentGatewaysFeesInner {
	if o == nil || IsNil(o.PaymentGatewaysFees) {
		var ret []FeedbackProductPaymentGatewaysFeesInner
		return ret
	}
...
// SetPaymentGatewaysFees gets a reference to the given []FeedbackProductPaymentGatewaysFeesInner and assigns it to the PaymentGatewaysFees field.
...
func (o FeedbackProduct) MarshalJSON() ([]byte, error) {
...
func (o FeedbackProduct) ToMap() (map[string]interface{}, error) {
...
type NullableFeedbackProduct struct {
	value *FeedbackProduct
	isSet bool
}

func (v NullableFeedbackProduct) Get() *FeedbackProduct {
	return v.value
}

func (v *NullableFeedbackProduct) Set(val *FeedbackProduct) {
	v.value = val
	v.isSet = true
}

func (v NullableFeedbackProduct) IsSet() bool {
	return v.isSet
}

func (v *NullableFeedbackProduct) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeedbackProduct(val *FeedbackProduct) *NullableFeedbackProduct {
	return &NullableFeedbackProduct{value: val, isSet: true}
}

func (v NullableFeedbackProduct) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeedbackProduct) UnmarshalJSON(src []byte) error {
	v.isSet = true
